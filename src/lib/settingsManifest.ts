...
export const MANIFEST = [
  ...
  { id: "keepUrlVideoCopies", label: "Download video",
    group: "recordingHistory", section: "Transcriptions", category: "fileTranscriptions",
    desc: "Fetch a link's video beside the audio, ready to export. Off: fetched only when you export it.",
  ...
  { id: "chipSize", label: "Chip size", group: "chip", category: "chip",
    desc: "Depends on this machine's displays.",
    machineSpecific: true, fields: [r("chipScale")] },
  { id: "keepChipDocked", label: "Keep chip docked", group: "chip", category: "chip",
    desc: "Depends on this machine's displays.",
    machineSpecific: true, fields: [r("persistentDock")] },
  { id: "dotSize", label: "Dot size", group: "chip", category: "chip",
    desc: "Depends on this machine's displays.",
    machineSpecific: true, fields: [r("dotScale")] },
